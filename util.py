...
# prediction is our output
# inp_dim is the input image dimension
# anchors
# num_classes
# optional CUDA falg, which is default to True
...
def predict_transform(prediction, inp_dim, anchors, num_classes, CUDA=True):
    ...
    # we must divide the anchors by the stride of the detection feature map
    anchors = [(a[0]/stride, a[1]/stride) for a in anchors]
    # now we need to transform our output according tothe equations;
    # sigmoid the x,y coordinates and the objectness score (object confidence)
...
# we must subject our output to objectness score thresholding and Non-maximal
# suppression, to obtain what I will call in the rest of this post as the true
# detections.
